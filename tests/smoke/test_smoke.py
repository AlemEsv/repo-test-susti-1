"""
Smoke Tests - Verificaciones básicas de que los servicios están funcionando
Estos tests se ejecutan rápidamente para verificar que la aplicación está "viva"
"""
import requests
import pytest
